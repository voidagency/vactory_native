...
export class AccessTokenEvents {
  ...
  load(container) {
    ...
    if (container.access_token && container.expires_in !== undefined) {
      ...
      Log.debug(
        "AccessTokenEvents.load: access token present, remaining duration: " + duration
      );
      ...
      if (duration > 0) {
        ...
        Log.debug(
          "AccessTokenEvents.load: registering expiring timer in: " + expiring
        );
      ...
      Log.debug(
        "AccessTokenEvents.load: registering expired timer in: " + expired,
      );
